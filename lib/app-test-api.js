  ...
  function createAppTestApi(input) {
    ...
    function assembleTestApi() {
      ...
      currentTestApi = {
        ...
        get notices() { return deps.getAppNotices(); },
        maybeDailySummary: function() {
          const n = deps.getAppNotices();
          return n && typeof n.maybeDailySummary === "function" ? n.maybeDailySummary() : null;
        },
        get APP_NOTICES_INSTANCE_CONTRACT() { return deps.APP_NOTICES_INSTANCE_CONTRACT; },
