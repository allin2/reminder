#!/usr/bin/env python3
"""5-layer resource closure verification for P3-H-R2.
...
APK_PATH = ROOT / "releases/candidates/20260923T1852-p3hr2-candidate/app-debug.apk"
...
def main():
    ...
    if len(files) != 35 or len(mismatches) != 0:
        print("ASSERTION FAILED in 5-layer check", file=sys.stderr)
        sys.exit(1)

    print("5-layer resource closure SUCCESS: 35/35 exact matches with genuine intermediate hashes!")
