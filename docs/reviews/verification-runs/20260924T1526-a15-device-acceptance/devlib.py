...
RAW = RUN / "raw"
ROOT = RUN.parents[3]
CANDIDATE = ROOT / "releases/candidates/20260924T1405-p4-device-candidate/app-debug.apk"
RAW_PRIVATE = pathlib.Path(os.environ.get("A15_PRIVATE_DIR", "/private/tmp/claude-501/-Users-qlyf-Developer-reminder/5f5c9ea0-11fa-4ed0-9d48-1e8bad8e2724/scratchpad/a15-private"))
