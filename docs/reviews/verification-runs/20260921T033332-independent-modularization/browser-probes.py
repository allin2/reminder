...
try:
 ...
 for case in ['control','missing-parser','feedback-member','feedback-null','incomplete-ui']:
 ...
 (RUN/'browser-probes-v2.json').write_text(json.dumps({'browser':info['Browser'],'results':results},ensure_ascii=False,indent=2))
