#!/usr/bin/env python3
"""Check every current Web resource across source, sync output, intermediate and APK for P3-F-R."""
import hashlib
import sys
import zipfile
...
apk = root / "releases/candidates/20260923T1330-p3fr-candidate/app-debug.apk"
