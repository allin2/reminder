...
- 运行目录：`/Users/qlyf/Developer/reminder/docs/reviews/verification-runs/20260923T074444Z-device-verify`
- 开始：2026-09-23T07:44:44Z  结束：2026-09-23T07:44:55Z
- **结论：PASS_WITH_WARN**（PASS 22 / FAIL 0 / WARN 2 / SKIP 2）
...
| B-01 | PASS | 命令通道往返 | {"sent": "dv8301f1da6f10", "received": "dv8301f1da6f10", "rc": 0} |
| B-02 | PASS | 设备时钟一致性 | {"deviceMs": 1790149488114, "hostMs": 1790149488696, "skewMs": -582} |
| B-03 | PASS | 文件通道一致性（64KB 往返） | {"algo": "sha256", "hostHash": "3a9fe0066f0453e9bedcdb5dcd2cec96457ab3fe491e76945df950071cb717fc", "deviceHash": "3a9fe0066f0453e9bedcdb5dcd2cec96457ab3fe491e76945df950071cb717fc", "pulledHash": "3a9fe0066f0453e9bedcdb5d… |
| B-04 | PASS | 二进制通道（exec-out 截屏） | {"bytes": 223904, "rc": 0} |
| B-05 | PASS | 端口转发通道 | {"port": "51289", "listed": true, "rc": 0} |
| B-06 | PASS | 日志通道（logcat 回读） | {"marker": "dvlog6f1c7b26f4", "matched": true, "logWriteRc": 0} |
...
| F-01 | PASS | 设备能力（屏幕/电量/存储） | {"wmSize": "1080x2400", "wmDensity": "480", "batteryLevel": 95, "batteryStatus": "0", "dataFree": "79162664", "wakefulness": "Awake"} |
...
| F-04 | PASS | 后台策略（appops / 电池白名单） | {"ops": {"SYSTEM_ALERT_WINDOW": "allow", "SCHEDULE_EXACT_ALARM": "allow"}, "batteryWhitelisted": false} |
| F-05 | WARN | 通知渠道（1/3） | {"expected": ["attention-alarm-v3", "attention-bridge-v2", "attention-alarm-guard"], "found": ["attention-bridge-v2"], "allChannelIds": ["10001", "10011", "10101", "110000", "110010", "110020", "110030", "ABUSIVE_BACKGRO… |
| F-06 | PASS | 闹钟排程（dumpsys alarm） | {"entriesForPackage": 8, "frozenMarkers": 14, "sample": ["          type=RTC_WAKEUP tag=*walarm*:space.alliswell.inbox/com.capacitorjs.plugins.localnotifications.TimedNotificationPublisher ", "          type=RTC_WAKEUP t… |
