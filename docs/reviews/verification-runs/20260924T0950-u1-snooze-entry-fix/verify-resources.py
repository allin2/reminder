#!/usr/bin/env python3
"""5-layer resource closure verification for U1 snooze-entry fix.
...
APK_PATH = ROOT / "releases/candidates/20260924T0950-u1-snooze-entry-fix-candidate/app-debug.apk"
