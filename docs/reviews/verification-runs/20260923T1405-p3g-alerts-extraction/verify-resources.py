#!/usr/bin/env python3
"""Check every current Web resource across source, sync output, intermediate and APK for P3-G."""
import hashlib
import sys
import zipfile
...
apk = root / "releases/candidates/20260923T1405-p3g-candidate/app-debug.apk"
