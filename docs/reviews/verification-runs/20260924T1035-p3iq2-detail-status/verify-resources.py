#!/usr/bin/env python3
"""5-layer resource closure verification for P3-I-Q2 detailReminderStatusRow migration.
...
APK_PATH = ROOT / "releases/candidates/20260924T1035-p3iq2-detail-status-candidate/app-debug.apk"
